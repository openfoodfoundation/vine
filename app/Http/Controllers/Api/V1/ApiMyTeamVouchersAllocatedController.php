...
#[Group('App Endpoints')]
#[Subgroup('/my-team-vouchers', 'Manage your team\'s vouchers. Returns vouchers allocated to your team.')]
class ApiMyTeamVouchersAllocatedController extends Controller
{
    ...
    {
        $this->query = Voucher::where('allocated_to_service_team_id', Auth::user()->current_team_id)
