...
#[Subgroup('/admin/team-merchant-teams', 'API for managing a team\'s merchant teams')]
class ApiAdminTeamMerchantTeamsController extends Controller
{
    ...
    #[Endpoint(
        title        : 'GET /',
        description  : 'Retrieve team merchant team associations.',
        authenticated: true
    )]
    #[Authenticated]
    #[QueryParam(
    ...
    #[Endpoint(
        title        : 'POST /',
        description  : 'Create a new merchant team merchant association for a team.',
        authenticated: true
    )]
    #[Authenticated]
    #[BodyParam(
        name       : 'team_id',
        type       : 'int',
        description: 'The database teams.id of the team you wish to associate a merchant team for.',
        required   : true
    )]
    #[BodyParam(
        name       : 'merchant_team_id',
        type       : 'int',
        description: 'The database teams.id of the merchant team you wish to associate to a team.',
        required   : true
    )]
    ...
    #[Endpoint(
        title        : 'Delete /{id}',
        description  : 'Remove a team\'s merchant association. {id} is the DB resource for the association',
        authenticated: true
    )]
