...
#[Subgroup('/admin/voucher-redemptions', 'Admin endpoint for unrestricted management of voucher redemptions')]
class ApiAdminVoucherRedemptionsController extends Controller
{
    ...
    #[Endpoint(
        title: 'GET /',
        description: 'Retrieve voucher redemptions.',
        authenticated: true
    )]
    #[Authenticated]
    #[QueryParam(
    ...
    public function index(): JsonResponse
    {
        ...
        $this->query = VoucherRedemption::with($this->associatedData);
    ...
    #[Endpoint(
        title: 'GET /{id}',
        description: 'Retrieve a single voucher redemption.',
        authenticated: true,
    )]
    #[Authenticated]
    #[UrlParam(
