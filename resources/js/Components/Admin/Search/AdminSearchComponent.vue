...
const $props = defineProps({
    filterToDataSets: {
        required: false,
        type: String,
        default: 'users,teams,vouchers,voucherSets'
    }
});
...
<template>
    ...
    <div class="h-full">
        <div v-if="showResults" class="">

            <div>

                <div v-if="searchResults.users.length > 0 && $props.filterToDataSets.includes('users')" class="mb-8">
                    ...
                    <div>
                        <div v-for="user in searchResults.users">
                            <a href="#"
                               @click.prevent="selectItem(voucher)"
                ...
                <div v-if="searchResults.teams.length > 0 && $props.filterToDataSets.includes('teams')" class="mb-8">
                    <div class="font-bold text-gray-300 mb-1">
                        Teams
                    </div>
                    <div>
                ...
                <div v-if="searchResults.voucherSets.length > 0 && $props.filterToDataSets.includes('voucherSets')"
                     class="my-8">
                    <div class="font-bold text-gray-300 mb-1">
                        Voucher Sets
                    </div>
                    <div>
                        <div v-for="voucherSet in searchResults.voucherSets">
                            <a href="#"
                               @click.prevent="selectItem(voucherSet)"
                               class="flex justify-between w-full py-2 border-b"
                               tabindex="0">
                                <div class="flex">
                ...
                <div v-if="searchResults.vouchers.length > 0 && $props.filterToDataSets.includes('vouchers')"
                     class="my-8">
                    <div class="font-bold text-gray-300 mb-1">
                        Vouchers
                    </div>
                            ...
                            <a href="#"
                               ...
                               tabindex="0">
                                <div class="flex">
                                    ...
                                    <div class="ml-2">
                                        <div
                                            v-html="highlightMatchingText('(' + voucher.voucher_short_code + ')')"></div>
                                    </div>
                                </div>
                                <i class="fa fa-chevron-right flex items-center"></i>
                            </a>
            ...
            <div v-if="showNoResults" class="absolute top-48 left-0 w-full h-full min-h-full min-w-full">
                ...
                <div
                    class="bg-white border rounded-lg p-4 mt-6 w-3/4 mx-auto z-20 relative overflow-y-scroll max-h-screen">
